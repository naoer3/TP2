...
public class ClassementZen extends Fragment {

    private View view;
    private TableLayout tableLayout = null;
    private String nom_prefs ="CLASSEMENT_ZEN";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        view = inflater.inflate(R.layout.fragment_classement_zen, container, false);
        tableLayout = view.findViewById(R.id.tbzen);
        return  view;
    }
    @Override
    public void onStart(){
